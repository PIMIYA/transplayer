  ...
  if (currentTime != previousTime) {
    ...
    (async()=>{
      if(currentTime == 0){
        ...
        await controller.setBrowserRect(0, { x: 0, y: 0, width: 1080, height: 1920 });
        await controller.goTo(1, 'https://www.straitstimes.com/global');
        await controller.setBrowserRect(1, { x: 1080, y: 0, width: 1080, height: 1920 });
        ...
        await controller.scrollTo(2, 300);
        //lauch new window
        ...
        await controller.scrollTo(3, 300);
        ...
        await controller.scrollTo(4, 3000);
        await controller.goTo(0, 'https://www.google.com/search?client=firefox-b-d&biw=1082&bih=884&tbm=vid&ei=ITnEXcGXHaSUmAXZmJCoBg&q=telecom+tower&oq=telecom+tower&gs_l=psy-ab.3..0i19k1l10.2108.5144.0.5281.13.11.0.2.2.0.64.569.11.11.0....0...1c.1.64.psy-ab..0.13.578...0j0i131k1j0i3k1j0i10k1j0i30k1j0i10i19k1.0.BJHO7TxPpVw');
        await controller.setBrowserRect(0, { x: 300, y: 300, width: 1024, height: 768 });
        await controller.clickElement(0, By.id('vidthumb1'),0);
        //???
        //await controller.clickElement(0, By.id('ytp-id-29'));
        ...
        await controller.scrollTo(4, 3000);
        await controller.goTo(0, 'https://www.youtube.com/results?search_query=elephant+violent&sp=CAMSAhAB');
        await controller.setBrowserRect(0, { x: 300, y: 300, width: 1024, height: 768 });
        await controller.clickElement(0, By.id('video-title'), 0);
        await controller.goTo(1, 'https://www.youtube.com/results?search_query=elephant+violent&sp=CAMSAhAB');
        await controller.setBrowserRect(1, { x: 1080, y: 300, width: 1024, height: 768 });
        await controller.clickElement(1, By.id('video-title'), 2);
        ...
        await controller.scrollTo(4, 3000);
        await controller.goTo(0, 'https://www.youtube.com/results?search_query=History+and+Ethnography+Museum+melaka&sp=CAM%253D');
        await controller.setBrowserRect(0, { x: 300, y: 300, width: 1024, height: 768 });
        await controller.clickElement(0, By.id('video-title'), 0);
        ...
        await controller.goTo(0, 'https://www.youtube.com/results?search_query=best+GUNPOWDER+EXPLOSION&sp=EgIQAQ%253D%253D');
        await controller.setBrowserRect(0, { x: 300, y: 300, width: 1024, height: 768 });
        await controller.clickElement(0, By.id('video-title'), 0);
        await controller.goTo(1, 'https://www.youtube.com/results?search_query=best+GUNPOWDER+EXPLOSION&sp=EgIQAQ%253D%253D');
        await controller.setBrowserRect(1, { x: 1080, y: 300, width: 1024, height: 768 });
        await controller.clickElement(1, By.id('video-title'), 0);
      }else if (currentTime == 775){
        await controller.closeBrowser(0);
        await delay(2000);
        await controller.closeBrowser(1);
        await delay(2000);
