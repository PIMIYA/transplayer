...
let task = {
  ...
  120: {
    action: async () => {
      ...
      //???
      await controller.clickElement(0, By.xpath('/html/body/ytd-app/div/ytd-page-manager/ytd-watch-flexy/div[3]/div[1]/div/div[1]/div/div/div/ytd-player/div/div/div[4]/button'));
    }
  },
  180: {
    action: async () => {
